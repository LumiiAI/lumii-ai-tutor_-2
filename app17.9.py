...
def normalize_message(message: str) -> str:
    ...
    msg = unicodedata.normalize(\"NFKC\", msg)# --- Normalize Unicode punctuation to ASCII equivalents ---
    ...
    # FIX #3: Normalize then remove combining marks (prevents g͟e͟n͟e͟t͟i͟c͟s / k͟i͟l͟l bypasses)
    msg = unicodedata.normalize("NFKD", msg)
    msg = "".join(ch for ch in msg if unicodedata.category(ch) not in ("Mn", "Me", "Cf"))
