...
FORBIDDEN_RESPONSE_PATTERNS = [
    re.compile(r"how to hurt yourself"),
    re.compile(r"how to kill yourself"),
    re.compile(r"take these pills"),
    re.compile(r"cut yourself here"),
    re.compile(r"encourage self-harm"),
    re.compile(r"provide methods to self-harm"),
]
...
with st.sidebar:
    ...
    **🌈 Identity Boundary** - I can listen kindly, but I won’t give personal advice; I’ll encourage you to talk with a parent/guardian or another trusted adultnclusive guidance for identity questions
