...
# =============================================================================
# MIDDLE GROUND APPROACH: IDENTITY vs SEXUAL HEALTH
# =============================================================================
...
def generate_response_with_memory_safety(message, priority, tool, student_age=10, is_distressed=False, safety_type=None, trigger=None):
    """Generate AI responses with middle-ground approach for sensitive topics"""
...
Please come back when you're ready to be respectful and learn together positively. I'll be here! 💙"""
    ...
    # Simple response generation for core academic support
    ...
    if priority == 'emotional':
        ...
        return response, "💙 Lumii's Emotional Support", "emotional", "🧠 With Memory"
        ...
        return response, "📚 Lumii's Organization Help", "organization", "🧠 With Memory"
        ...
        return response, "🧮 Lumii's Math Expertise", "math", "🧠 With Memory"
...
# =============================================================================
# CUSTOM CSS STYLING - PROPERLY FORMATTED
# =============================================================================
